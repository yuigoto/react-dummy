 ...
 * iOwnStyle
 * ----------------------------------------------------------------------
 * Oferece assinatura de tipo para formatação do componente.
 *
 * Offers type signatures for the component style.
 * 
 * @since 0.0.1
 */
interface iOwnStyle {
...
/**
 * Stylesheet do componente.
 * 
 * Component stylesheet.
 */
const Styles: iOwnStyle = StyleSheet.create<iOwnStyle>({
  text: {
    color: "#ff0000",
    fontWeight: "700", 
    textAlign: "center"
...
class DummyComponentContainer extends Component<DummyComponentProps> {
  ...
  /**
   * Método de teste para press de botão.
   * 
   * Test method for button press.
   * 
   * @param e 
   */
  pressEvent = (e: any): void => {
    console.log("I was pressed at " + (Date.now()));
  };
