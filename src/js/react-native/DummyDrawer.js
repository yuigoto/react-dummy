 ...
 * DummyDrawer
 * ----------------------------------------------------------------------
 * Exemplo de componente de navegação para Native.
 * Example of a navigator component for Native.
 * 
 * @since 0.0.0
 */
class DummyDrawer extends Component {
  // PROPRIEDADES
  // PROPERTIES
  // --------------------------------------------------------------------
  ...
  /**
   * Pega formatação das props, alimenta um array para uso com spreading.
   * 
   * Fetches style from props, feeds an array so we can use it for spreading.
   *
  ...
  render () {
    ...
    // Se o componente for "navigation-aware"
    // If the component is "navigation-aware"
